...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eth-rlp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10596&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eth-rlp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eth-rlp` can be installed with:

```
conda install eth-rlp
```

It is possible to list all of the versions of `eth-rlp` available on your platform with:
